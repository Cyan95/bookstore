...
import (
	"github.com/Cyan95/day02/bookstore0612/controller"
	"net/http"
)
...
func main() {
	...
	http.Handle("/assets/", http.StripPrefix("/assets/", http.FileServer(http.Dir("views/pages/resume/assets"))))
	http.HandleFunc("/main", controller.GetPageBooksByPrice)
	//去登录
	http.HandleFunc("/login", controller.Login)
	//去注销
	http.HandleFunc("/logout", controller.Logout)
	http.HandleFunc("/resume", controller.ResumeHandler)
	//去注册
